...
def evaluation(
    ...
    has_native_variable_gate = False
    has_gate_diag = False
    ...
    if base_se_sum is not None:
        ...
        if has_relevance_diag:
            ...
            if has_native_variable_gate:
                results["text_variable_gate_per_variable"] = (
                    _to_named_dict(names, relevance_var)
                )
                results["text_variable_gate_mean"] = (
